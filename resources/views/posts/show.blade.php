<!DOCTYPE html>
 ...
 <body style="padding: 60px 0;">
     <header>
         <nav class="navbar navbar-light bg-light fixed-top" style="height: 60px 0;">
             <div class="container">
     ...
     <footer class="d-flex justify-content-center align-items-center bg-light fixed-bottm" style="height: 60px">        
